...
void setup() {
  ...
  scale1.set_scale(-3839.888);//This value is obtained by using the SparkFun_HX711_Calibration sketch
  scale2.set_scale(-2889.83);//This value is obtained by using the SparkFun_HX711_Calibration sketch
  scale3.set_scale(-3839.594);//This value is obtained by using the SparkFun_HX711_Calibration sketch
  scale4.set_scale(-3914.376);//This value is obtained by using the SparkFun_HX711_Calibration sketch
