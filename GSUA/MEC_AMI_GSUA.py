...
def RUN_SIM(test):     # used to package this version of the MEC as a function callable by other programs
    if test == 'sobol':
        print('Running simulation with sobol sampling')
    elif test == 'morris':
        print('Running simulation with morris sampling')

"""FINISH REWRITING THESE MODELS TO ACCEPT EITHER VERSION"""
