...
def RUN_SIM():     # used to package this version of the MEC as a function callable by other programs
    ...
    param_values = np.loadtxt('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/GSUA/test_GSUA_parameters.txt') # loads the parameters generated by the main GSUA program
    ...
    for i, X in enumerate(param_values):        
        ...
        df_sims.to_csv('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/GSUA/GSUA_AMI_out/data/test_GSUA_AMI_Simulations.csv') # exports entire final data frame to a CSV
        for output in mec_outputs:      # This loop runs create text files for each /inputoutput of the MEC!
            np.savetxt(f'C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/GSUA/GSUA_AMI_out/data/test_GSUA_AMI_data_{output[0]}.txt', df_sims[[f'{output[0]}']])
