...
def CLEAR_OUTPUTS(): # I can't get this to work properly! Grrr
    open(f'C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/GSUA/GSUA_CAV_out/data/GSUA_CAV_Simulations.csv', 'w').close() # clears contents of before writing new batch
    for output in outputs:      # This loop runs create text files for each /inputoutput of the MEC!
        open(f'C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/GSUA/GSUA_CAV_out/data/GSUA_CAV_data_{output[0]}.txt', 'w').close() # clears contents of output files before writing new batch
