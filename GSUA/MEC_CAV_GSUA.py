...
def RUN_SIM():     # used to package this version of the MEC as a function callable by other programs
    ...
    ##########################################################
        ...
        df_sims.to_csv('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/GSUA/GSUA_CAV_out//data/full_GSUA_CAV_Simulations.csv') # exports entire final data frame to a CSV
        for output in mec_outputs:      # This loop runs create text files for each /inputoutput of the MEC!
            np.savetxt(f'C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/GSUA/GSUA_CAV_out/data/full_GSUA_CAV_data_{output[0]}.txt', df_sims[[f'{output[0]}']])
...
def RUN_CHART():
    ...
    for item in mec_inputs:        # this allows easy injection of labels into chart elements
        ...
        for item in mec_outputs:
            ...
            plt.savefig(f'C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/GSUA/GSUA_CAV_out/figures/full_CAV {input_short_name} x {output_short_name}.png', bbox_inches='tight') #there are many options for savefig
