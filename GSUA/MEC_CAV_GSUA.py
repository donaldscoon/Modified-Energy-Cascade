...
def RUN_CAV():     # used to package this version of the MEC as a function callable by other programs
    ...
    param_values = np.loadtxt('C:/Users/donal/Documents/Github/Modified-Energy-Cascade/GSUA/GSUA_parameters.txt') # loads the parameters generated by the main GSUA program
    ...
    ##########################################################
        ...
        df_sims.to_csv('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/GSUA/GSUA_CAV_out/GSUA_CAV_Simulations.csv') # exports entire final data frame to a CSV
        for output in mec_outputs:      # This loop runs create text files for each output of the MEC!
            np.savetxt(f'C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/GSUA/GSUA_CAV_out/GSUA_CAV_data_{output}.txt', df_sims[[f'{output}']])
