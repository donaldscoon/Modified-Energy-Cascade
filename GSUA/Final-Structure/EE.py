...
def ANALYZE():
    ...
    X_df = pd.read_csv('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/GSUA/Final-Structure/SOBOL_parameters.txt',
    ...
    N = pd.Series({c: EE_out_df[c].unique() for c in EE_out_df}) # number of unique levels resulting from the sobol sampling
    print(N)
