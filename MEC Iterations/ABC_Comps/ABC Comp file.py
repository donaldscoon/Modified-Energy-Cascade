...
# fig, ax = plt.subplots()
# ax.plot(bigdf['Day'], bigdf['AMI_alpha'],       marker='o', color='#067300',    label='AMI α')
# ax.plot(bigdf['Day'], bigdf['BOS_AVG_ALPHA'],   marker='s', color='#09B600',    label='BOS α')
# ax.plot(bigdf['Day'], bigdf['CAV_ALPHA'],       marker='^', color='#96F391',    label='CAV α')
# ax.plot(bigdf['Day'], bigdf['AMI_beta'],        marker='o', color='#2A119B',    label='AMI β')
...
# #################### A, CQY, CUE, ###################################
# fig, ax = plt.subplots()
# ax.plot(bigdf['Day'], bigdf['BOS_AVG_A'],      marker='s', color='#2A119B',  label='BOS A')
...
# ############### Conductances #########################
# fig, ax = plt.subplots()
# ax.plot(bigdf['Day'], bigdf['AMI_g_S'],     marker='o', color='#067300',     label='AMI g$_S$')
# ax.plot(bigdf['Day'], bigdf['BOS_AVG_g_S'], marker='s', color='#09B600',     label='BOS g$_S$')
# ax.plot(bigdf['Day'], bigdf['CAV_g_S'],     marker='^', color='#96F391',     label='CAV g$_S$')
# ax.plot(bigdf['Day'], bigdf['AMI_g_C'],     marker='o', color='#2A119B',     label='AMI g$_C$')
...
# ax.plot(bigdf['Day'], bigdf['AMI_P_NET'],       marker='o', color='#2A119B',    label='AMI P$_{NET}$')
...
################### Layerd Chart, Edible Biomass ###################################
fig, ax = plt.subplots()
ax.set_ylabel('grams m$^{-2}$', fontsize= 14)
ax.set_xlabel('Days After Emergence', fontsize= 14)
ax.tick_params(labelsize= 12)
plt.title('Crop Productivity', fontsize= 16)
ax.plot(bigdf['Day'], bigdf['OBS_TEB'],      marker='.', color='black',    label='Observed TEB')
plt.figlegend(bbox_to_anchor=(-0.08, 0.39, 0.5, 0.5), prop={'size': 12})
plt.savefig('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/ABC_Comps/Layered_Charts/TEB_1.png', bbox_inches='tight') #there are many options for savefig
# plt.show()
...
ax.tick_params(labelsize= 12)
plt.title('Crop Productivity', fontsize= 16)
ax.plot(bigdf['Day'], bigdf['AMI_TEB'],      marker='o', color='#5E46C6',  label='AMI TEB')
ax.plot(bigdf['Day'], bigdf['OBS_TEB'],      marker='.', color='black',    label='Observed TEB')
plt.figlegend(bbox_to_anchor=(-0.08, 0.39, 0.5, 0.5), prop={'size': 12})
plt.savefig('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/ABC_Comps/Layered_Charts/TEB_2.png', bbox_inches='tight') #there are many options for savefig
# plt.show()
...
plt.title('Crop Productivity', fontsize= 16)
ax.plot(bigdf['Day'], bigdf['AMI_TEB'],      marker='o', color='#5E46C6',  label='AMI TEB')
ax.plot(bigdf['Day'], bigdf['CAV_TEB'],      marker='^', color='#DF0006',  label='CAV TEB')
ax.plot(bigdf['Day'], bigdf['OBS_TEB'],      marker='.', color='black',    label='Observed TEB')
plt.figlegend(bbox_to_anchor=(-0.08, 0.39, 0.5, 0.5), prop={'size': 12})
plt.savefig('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/ABC_Comps/Layered_Charts/TEB_3.png', bbox_inches='tight') #there are many options for savefig
# plt.show()


############### Layered Conductances #########################
fig, ax = plt.subplots()
ax.plot(bigdf['Day'], bigdf['OBS_g_S'],     marker='.', color='black',       label='Observed g$_S$')
ax.set_ylabel('mol$_{water}$ m$^{-2}$ second $^{-1}$', fontsize= 14)
ax.set_xlabel('Days After Emergence', fontsize= 14)
...
plt.figlegend(bbox_to_anchor=(-0.1, 0.39, 0.5, 0.5), prop={'size': 12})
plt.title('Conductances', fontsize= 16)
plt.savefig('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/ABC_Comps/Layered_Charts/g_1.png', bbox_inches='tight') #there are many options for savefig
# plt.show()

fig, ax = plt.subplots()
ax.plot(bigdf['Day'], bigdf['AMI_g_S'],     marker='o', color='#5E46C6',     label='AMI g$_S$')
ax.plot(bigdf['Day'], bigdf['BOS_AVG_g_S'], marker='s', color='#09B600',     label='BOS g$_S$')
ax.plot(bigdf['Day'], bigdf['CAV_g_S'],     marker='^', color='#DF0006',     label='CAV g$_S$')
ax.plot(bigdf['Day'], bigdf['OBS_g_S'],     marker='.', color='black',       label='Observed g$_S$')
ax.set_ylabel('mol$_{water}$ m$^{-2}$ second $^{-1}$', fontsize= 14)
ax.set_xlabel('Days After Emergence', fontsize= 14)
ax.tick_params(labelsize= 12)
plt.figlegend(bbox_to_anchor=(-0.1, 0.39, 0.5, 0.5), prop={'size': 12})
plt.title('Conductances', fontsize= 16)
plt.savefig('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/ABC_Comps/Layered_Charts/g_2.png', bbox_inches='tight') #there are many options for savefig
# plt.show()
...
ax.plot(bigdf['Day'], bigdf['BOS_AVG_g_S'], marker='s', color='#09B600',     label='BOS g$_S$')
ax.plot(bigdf['Day'], bigdf['CAV_g_S'],     marker='^', color='#DF0006',     label='CAV g$_S$')
ax.plot(bigdf['Day'], bigdf['AMI_g_C'],     marker='o', color='#A798EC',     label='AMI g$_C$')
ax.plot(bigdf['Day'], bigdf['BOS_AVG_g_C'], marker='s', color='#96F391',     label='BOS g$_C$')
ax.plot(bigdf['Day'], bigdf['CAV_g_C'],     marker='^', color='#FE989A',     label='CAV g$_C$')
ax.plot(bigdf['Day'], bigdf['OBS_g_S'],     marker='.', color='black',       label='Observed g$_S$')
ax.set_ylabel('mol$_{water}$ m$^{-2}$ second $^{-1}$', fontsize= 14)
ax.set_xlabel('Days After Emergence', fontsize= 14)
ax.tick_params(labelsize= 12)
plt.figlegend(bbox_to_anchor=(-0.1, 0.39, 0.5, 0.5), prop={'size': 12})
plt.title('Conductances', fontsize= 16)
plt.savefig('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/ABC_Comps/Layered_Charts/g_3.png', bbox_inches='tight') #there are many options for savefig
# plt.show()

################ Layered Chart Exchanges ######################
fig, ax= plt.subplots()
ax.plot(bigdf['Day'], bigdf['OBS_DTR'],     marker='.', color='black',    label='Observed DTR')
ax.set_ylabel('L$_{water}$ m$^{-2}$ day$^{-1}$', fontsize= 14)
ax.set_xlabel('Days After Emergence', fontsize= 14)
...
plt.figlegend(bbox_to_anchor=(-0.075, 0.39, 0.5, 0.5), prop={'size': 12})
plt.title('Daily Transpiration Rate', fontsize= 16)
plt.savefig('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/ABC_Comps/Layered_Charts/DTR_1.png', bbox_inches='tight') #there are many options for savefig
# plt.show()

fig, ax= plt.subplots()
ax.plot(bigdf['Day'], bigdf['AMI_DTR'],     marker='o', color='#5E46C6',  label='AMI DTR')
ax.plot(bigdf['Day'], bigdf['OBS_DTR'],     marker='.', color='black',    label='Observed DTR')
ax.set_ylabel('L$_{water}$ m$^{-2}$ day$^{-1}$', fontsize= 14)
ax.set_xlabel('Days After Emergence', fontsize= 14)
ax.tick_params(labelsize= 12)
plt.figlegend(bbox_to_anchor=(-0.075, 0.39, 0.5, 0.5), prop={'size': 12})
plt.title('Daily Transpiration Rate', fontsize= 16)
plt.savefig('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/ABC_Comps/Layered_Charts/DTR_2.png', bbox_inches='tight') #there are many options for savefig
# plt.show()
...
plt.figlegend(bbox_to_anchor=(-0.075, 0.39, 0.5, 0.5), prop={'size': 12})
plt.title('Daily Transpiration Rate', fontsize= 16)
plt.savefig('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/ABC_Comps/Layered_Charts/DTR_3.png', bbox_inches='tight') #there are many options for savefig
# plt.show()

fig, ax= plt.subplots()
ax.plot(bigdf['Day'], bigdf['AMI_DTR'],     marker='o', color='#5E46C6',  label='AMI DTR')
ax.plot(bigdf['Day'], bigdf['BOS_AVG_DTR'], marker='s', color='#09B600',  label='BOS DTR')
ax.plot(bigdf['Day'], bigdf['CAV_DTR'],     marker='^', color='#DF0006',  label='CAV DTR')
ax.plot(bigdf['Day'], bigdf['OBS_DTR'],     marker='.', color='black',    label='Observed DTR')
ax.set_ylabel('L$_{water}$ m$^{-2}$ day$^{-1}$', fontsize= 14)
ax.set_xlabel('Days After Emergence', fontsize= 14)
ax.tick_params(labelsize= 12)
plt.figlegend(bbox_to_anchor=(-0.075, 0.39, 0.5, 0.5), prop={'size': 12})
plt.title('Daily Transpiration Rate', fontsize= 16)
plt.savefig('C:/Users/donal/Documents/GitHub/Modified-Energy-Cascade/ABC_Comps/Layered_Charts/DTR_4.png', bbox_inches='tight') #there are many options for savefig
# plt.show()
