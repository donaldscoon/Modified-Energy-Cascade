    ...
    for item in outputs:   # loop for outputs
        ...
        for item in models:                 # loop for model names
            ...
            if not all(x == 0 for x in X) or not all(y == 0 for y in Y):
                ...
                plt.scatter(mu_star_temp, sigma_temp,    s=50, marker= 'o', color= color)
                plt.scatter(mu_star_rh, sigma_rh,        s=50, marker= 's', color= color)
                plt.scatter(mu_star_CO2, sigma_CO2,      s=50, marker= '*', color= color)
                plt.scatter(mu_star_PPFD, sigma_PPFD,    s=50, marker= '^', color= color)
    ...
    for item in outputs:   # loop for outputs
        ...
        for item in models:                 # loop for model names
            ...
            if not all(x == 0 for x in X) or not all(y == 0 for y in Y):
                ...
                # Create the scatter plot
                plt.scatter(mu_temp, sigma_temp,    s=50, marker= 'o', color= color)
                plt.scatter(mu_rh, sigma_rh,        s=50, marker= 's', color= color)
                plt.scatter(mu_CO2, sigma_CO2,      s=50, marker= '*', color= color)
                plt.scatter(mu_PPFD, sigma_PPFD,    s=50, marker= '^', color= color)
                plt.scatter(mu_H, sigma_H,          s=50, marker= 'd', color= color)
